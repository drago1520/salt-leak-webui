...
- The current system can handle 4095 req/ ms per machine per data center because of the ID generation. We only need 20 records/ **second** normally for 200 sensors. 2k req/ **second** max if all sensors error out somehow.
...
- COM ports on Bun don't work => Use node.js v24.14.1
